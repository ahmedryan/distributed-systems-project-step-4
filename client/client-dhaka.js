...
const url_communication = process.env.URL_COMMUNICATION_DHAKA;
const socket = io.connect(url_communication);

const api_rating = process.env.API_RATING_DHAKA;
...
const driver_api = process.env.API_DRIVER_DHAKA;
const rider_api = process.env.API_RIDER_DHAKA; 
...
setInterval(function() {
    ...
    let driver_name = 'dhakaiya-driver-' + count;
    ...
    let rider_name = 'dhakaiya-rider-' + count;
